...
# ### Load image from previous script, 6.1.2 --------------------
...
granulo.0_5.s <- stack(argile.alr.cub.0_5, silt.alr.cub.0_5,
                       ...
                       argile.preds.RK.0_5,limon.preds.RK.0_5,sable.preds.RK.0_5)
...
ru_vol_0_5 <- raster("ru_vol_0_5.tif")
ru_mm_0_5 <- raster("ru_mm_0_5.tif")
awc_mm_0_5 <- raster("awc_mm_0_5.tif")
awc.0_5.s <- stack(SMFC_0_5, SMPWP_0_5,ru_vol_0_5,ru_mm_0_5,coarse.qrF.mean.0_5,awc_mm_0_5)
...
dir.create(paste0(HomeDir,"Clean_Output/7.1-AWC_Taylor_0_5"))
...
tic <- Sys.time()
argile.alr.v <- getValues(argile.alr.preds.0_5)
silt.alr.v <- getValues(limon.alr.preds.0_5)

### calculate correlation
cor.clay.limon.alr.0_5 <- cor.test(x=argile.alr.v, y=silt.alr.v, na.rm=TRUE, method="pearson")
cor.clay.limon.alr.0_5$estimate
tac <- Sys.time()
tac-tic; rm(tic, tac)
...
t_layer <- 50 ### thickness of layer in mm
...
## my intput raster stack is granulo.0_5.s
names(granulo.0_5.s)
...
#  s[[1]] "argile.alr.cub.0_5" 
#  s[[2]] "silt.alr.cub.0_5" 
#  s[[3]] "argile.alr.ckR.0_5" 
#  s[[4]] "limon.alr.ckR.0_5"  
#  s[[5]] "argile.alr.ckSTD.0_5"
#  s[[6]] "limon.alr.ckSTD.0_5"
#  s[[7]] "argile.alr.preds.0_5"
#  s[[8]] "limon.alr.preds.0_5" 
#  s[[9]] "clay" 
#  s[[10]] "silt" 
#  s[[11]] "sand"
...
rho <- cor.clay.limon.alr.0_5$estimate

beginCluster(4)
var_w20_input_0_5 <- clusterR(granulo.0_5.s, ff, export = list("Uncertainty_input","ptf", "rho"),
                          filename = paste0("varInput_w20_",depth,".tif"), format = "GTiff",
                          na.rm=T, inf.rm=T, progress = "text", overwrite = T)
endCluster()

var_w20_input_0_5 <- raster(paste0("varInput_w20_",depth,".tif"))
...
beginCluster(7)
var_w42_input_0_5  <- clusterR(granulo.0_5.s, ff, export = list("Uncertainty_input","ptf","rho"),
                          filename = paste0("varInput_w42_",depth,".tif"), format = "GTiff",
                          na.rm=T, inf.rm=T, progress = "text", overwrite = T)
endCluster()

var_w42_input_0_5 <- raster(paste0("varInput_w42_",depth,".tif"))

par(mfrow=c(3,2))
plot(var_w20_input_0_5)
plot(var_w42_input_0_5)
...
beginCluster(4)
var_w20_ptf_0_5 <- clusterR(granulo.0_5.s, ff, export = list("Uncertainty_PTF","coeff.var.covar"),
                        filename = paste0("varPTF_w20_",depth,".tif"), format = "GTiff",
                        na.rm=T, inf.rm=T, progress = "text", overwrite = T)
endCluster()

var_w20_ptf_0_5 <- raster(paste0("varPTF_w20_",depth,".tif"))
...
beginCluster(4)
var_w42_ptf_0_5 <- clusterR(granulo.0_5.s, ff, export = list("Uncertainty_PTF","coeff.var.covar"),
                        filename = paste0("varPTF_w42_",depth,".tif"), format = "GTiff",
                        na.rm=T, inf.rm=T, progress = "text", overwrite = T)
endCluster()

gc()
var_w42_ptf_0_5 <- raster(paste0("varPTF_w42_",depth,".tif"))

plot(var_w20_ptf_0_5)
plot(var_w42_ptf_0_5)
...
var.awc.s <- stack (var_w20_input_0_5, var_w42_input_0_5, var_w20_ptf_0_5, var_w42_ptf_0_5)
...
beginCluster(4)
total_var_w20.0_5 <- clusterR(var.awc.s, calc, args = list(sum_unc_w20),
                                 filename =paste0("Total_var_w20.",depth,".tif"), format = "GTiff",
                                 na.rm=T,inf.rm=T, progress = "text", overwrite = T)
endCluster()

total_var_w20.0_5 <- raster(paste0("Total_var_w20.",depth,".tif"))


beginCluster(4)
total_var_w42.0_5 <- clusterR(var.awc.s, calc, args = list(sum_unc_w42),
                              filename =paste0("Total_var_w42.",depth,".tif"), format = "GTiff",
                              na.rm=T,inf.rm=T, progress = "text", overwrite = T)
endCluster()

total_var_w42.0_5 <- raster(paste0("Total_var_w42.",depth,".tif"))

plot(total_var_w20.0_5)
plot(total_var_w42.0_5)

# Add to the stack
var.awc.s <- stack(var.awc.s, total_var_w20.0_5, total_var_w42.0_5)

####################################################################################################################

### Clean the workspace a bit
rm(ru_coarse, difference, ff, ru_mm, tic, tac, rho, rho.awc, argile.alr.cub.0_5, silt.alr.cub.0_5,
   argile.alr.cub.0_5,silt.alr.cub.0_5,argile.alr.ckR.0_5,limon.alr.ckR.0_5,
   argile.alr.ckSTD.0_5 , limon.alr.ckSTD.0_5 , argile.alr.limon.alr.cov.0_5, argile.alr.preds.0_5,        
   limon.alr.preds.0_5, clay ,silt , sand,argile.preds.RK.0_5, limon.preds.RK.0_5, sable.preds.RK.0_5,
   var_w20_input_0_5, var_w42_input_0_5, var_w20_ptf_0_5, var_w42_ptf_0_5, var_awc_0_5, total_var_w42.0_5,
   total_var_w20.0_5,coarse.qrF.mean.0_5, coarse.qrF.sd.0_5, coarse.qrF.05.0_5, coarse.qrF.95.0_5,
   SMFC_0_5, SMPWP_0_5, ru_vol_0_5, ru_mm_0_5, silt.alr.v, argile.alr.v, SMFC_0_5.v, SMPWP_0_5.v,
   ptf, coeff.var.covar)
...
beginCluster(7)
var_clay_0_5 <- clusterR(granulo.0_5.s, ff, export = list("var_back_CLAY","rho"),
                             filename = paste0("var_clay_",depth,".tif"), format = "GTiff",
                             na.rm=T, inf.rm=T, progress = "text", overwrite = T)
endCluster()

plot(var_clay_0_5)
var_clay_0_5 <- raster(paste0("var_clay_",depth,".tif"))
...
beginCluster(7)
var_silt_0_5 <- clusterR(granulo.0_5.s, ff, export = list("var_back_SILT","rho"),
                         filename = paste0("var_silt_",depth,".tif"), format = "GTiff",
                         na.rm=T, inf.rm=T, progress = "text", overwrite = T)
endCluster()

plot(var_silt_0_5)
var_silt_0_5 <- raster(paste0("var_silt_",depth,".tif"))
...
beginCluster(7)
var_sand_0_5 <- clusterR(granulo.0_5.s, ff, export = list("var_back_SAND","rho"),
                         filename = paste0("var_sand_",depth,".tif"), format = "GTiff",
                         na.rm=T, inf.rm=T, progress = "text", overwrite = T)
endCluster()
var_sand_0_5 <- raster(paste0("var_sand_",depth,".tif"))

plot(var_sand_0_5)
par(mfrow=c(1,3))
plot(sqrt(var_clay_0_5))
plot(sqrt(var_silt_0_5))
plot(sqrt(var_sand_0_5))

### Save image
rm(var_back_CLAY)
save.image("7.1-AWC_Taylor_0_5.RData")
